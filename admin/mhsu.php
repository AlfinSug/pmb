        ...
        <div class="bg-light warna" style="margin-top: 100px; border-radius: 10px; width: 97%">
            <div class="row justify-content-center">
                <div class="col-11 mt-4">
                    ...
                    <!-- TABEL -->
                    <table class="table table-hover table-striped" style="width: 106%; margin-left: -4.25%">
                        ...
                        <tbody style="font-size: 15px">
                            <?php
                            require_once "models/modelmhsu.php";
                            $object = new modelmhsu();
                            $object->vimhs();
                            $mhsu = $object->vimhs();
                            foreach ($mhsu as $see) {
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <div align="center">
                                            ...
                                            <a href="proses/prosesMhsu.php?aksi=delete&npm=<?php echo $see['npm']; ?>"><button type="button" class="text-light btn btn-danger btn-sm font-weight-bolder" style="margin-top: 5px">Delete</button></a><br>
                                            <?php
                                                $verif = $see['verifikasi'];
                                                if ($verif == "NULL" /*UPDATE */|| $verif == "" /*UPDATE_TUTUP*/) { ?>
                                                <a href="proses/prosesMhsu.php?aksi=tombol&npm=<?php echo $see['npm']; ?>"><button type="button" class="btn btn-info btn-sm font-weight-bolder" style="margin-top: 5px">Verify</button></a>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form enctype="multipart/form-data" action="proses/prosesMhsu.php?aksi=ubah&id=<?php echo $see['npm']; ?>" method="POST">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8 ml-1">
                                                            <select class="form-control" id="jrsn" name="jrsn">
                                                                ...
                                                                <?php
                                                                    $sambunganDB = mysql_connect("localhost", "root", "", "pmb");
